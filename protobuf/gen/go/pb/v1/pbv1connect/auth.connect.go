...
import (
	...
	v1 "github.com/migerick/cookie-authentication-go/protobuf/pb/v1"
	http "net/http"
	strings "strings"
)
...
func (UnimplementedAuthServiceHandler) Login(context.Context, *connect_go.Request[v1.LoginRequest]) (*connect_go.Response[v1.LoginResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("pb.v1.AuthService.Login is not implemented"))
}
